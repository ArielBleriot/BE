...
namespace BridgeRTU.Migrations
{
    ...
    [Migration("20250328092323_AddEmailVerification")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BridgeRTU.Domain.ActivityRegistration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BridgeRTU.Domain.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BridgeRTU.Domain.EmailVerification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BridgeRTU.Domain.PasswordResetToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BridgeRTU.Domain.ActivityRegistration", b =>
                {
                    b.HasOne("BridgeRTU.Domain.Activity", "Activity")
                        .WithMany()
            ...
            modelBuilder.Entity("BridgeRTU.Domain.Comment", b =>
                {
                    b.HasOne("BridgeRTU.Domain.Project", "Project")
                        .WithMany("Comments")
